...
$(document).ready(function() {
    ...
    /**
     * NEW: This function reads all active filters and generates the visual tags.
     */
    function updateActiveFiltersDisplay() {
        ...
        $('.main-category-filter.active, .subcategory-filter.active').each(function() {
            // Only show a tag if it's not the base subcategory of the page itself
            if ($(this).data('id') != $('#product-list').data('base-subcategory-id')) {
    ...
    // Your getFilters function is already correct for this page's context.
    function getFilters() {
    ...
    function loadProducts(reset = false) {
        ...
        updateActiveFiltersDisplay(); // Call this function to update tags every time
    ...
    // Sidebar filter listeners - no changes needed
    ...
    $('#clear-all-filters').on('click', function(e) {
        ...
        $('#sort-select-new').val('default');
        // Reload products, which will revert to the page's base subcategory
        loadProducts(true);
    });
});
</script>
