...
$(document).ready(function() {
    ...
    /**
     * This function reads all active filters from the sidebar
    ...
    // Initial call to set tags if the page loads with filters already applied
    ...
    function handleCategoryClick(selector, otherSelectors) {
        $(document).on('click', selector, function(e) {
            ...
            // Remove active class from all category links first
            $('.main-category-filter, .subcategory-filter, .animation-category-filter').removeClass('active');
            
            // If the clicked link was not active, make it active
            if (!wasActive) {
                $el.addClass('active');
            }
